      ...
      <div className="max-w-7xl mx-auto px-4 -mt-8">
        ...
        <div className="mt-12 bg-emerald-600 rounded-3xl p-6 md:p-10 relative overflow-hidden shadow-2xl shadow-emerald-600/20">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <button className="px-6 py-3.5 bg-white text-emerald-600 rounded-xl font-bold hover:bg-emerald-50 transition-all flex items-center gap-2 shadow-xl shrink-0 text-sm">
              Suggérer une offre
