...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const allNavItems = [
    ...
    { icon: Trophy, label: 'Concours Fonction Publique 🇧🇫', to: '/public-service-contests', roles: ['admin', 'teacher', 'alumni', 'parent', 'student', 'public'] },
    { icon: FileText, label: 'Générateur de CV', to: '/cv-generator', roles: ['admin', 'alumni', 'teacher', 'parent'] },
    { icon: Tag, label: 'Bons Plans', to: '/deals', roles: ['admin', 'alumni', 'teacher', 'parent', 'public'] },
    { icon: Home, label: 'Colocation', to: '/colocation', roles: ['admin', 'teacher', 'alumni', 'parent', 'public'] },
