...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const allNavItems = [
    ...
    { icon: Sparkles, label: 'Bourses & Opportunités IA', to: '/scholarships', roles: ['student', 'admin', 'teacher', 'alumni', 'parent'] },
    ...
    { icon: Compass, label: 'Orientation', to: '/orientation', roles: ['student', 'admin', 'parent', 'teacher'] },
    { icon: Brain, label: 'Révisions & Quiz', to: '/quizzes', roles: ['student', 'admin', 'teacher'] },
    { icon: Trophy, label: 'Concours Fonction Publique 🇧🇫', to: '/public-service-contests' },
    { icon: FileText, label: 'Générateur de CV', to: '/cv-generator', roles: ['student', 'admin', 'alumni', 'teacher'] },
    { icon: Tag, label: 'Bons Plans', to: '/deals', roles: ['student', 'admin', 'alumni', 'teacher'] },
    { icon: Home, label: 'Colocation', to: '/colocation', roles: ['student', 'admin', 'teacher'] },
    { icon: User, label: 'Portfolio', roles: ['teacher', 'admin'], to: '/portfolio' },
