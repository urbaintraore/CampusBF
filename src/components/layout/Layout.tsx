...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const allNavItems = [
    ...
    { icon: FileText, label: 'Générateur de CV', to: '/cv-generator', roles: ['admin', 'alumni', 'teacher'] },
    { icon: Tag, label: 'Bons Plans', to: '/deals', roles: ['admin', 'alumni', 'teacher'] },
    { icon: Home, label: 'Colocation', to: '/colocation', roles: ['admin', 'teacher'] },
